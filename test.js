...
test("create new v1 tag", async (t) => {
  const mock = nock("https://api.github.com")
    ...
    .get("/repos/gr2m/semantic-release-breaking-version-tag/git/ref/tags%2Fv1")
    .reply(404)
    // create tag
    .post(
      "/repos/gr2m/semantic-release-breaking-version-tag/git/refs",
      (body) => {
  ...
  await success(
    {},
    {
      ...
      options: {
        repositoryUrl:
          "https://github.com/gr2m/semantic-release-breaking-version-tag",
      },
    }
  );
...
test("update existing v1 new tag", async (t) => {
  const mock = nock("https://api.github.com")
    ...
    // update tag
    .patch(
      "/repos/gr2m/semantic-release-breaking-version-tag/git/refs/tags%2Fv1",
      (body) => {
